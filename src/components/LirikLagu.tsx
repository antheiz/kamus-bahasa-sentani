    ...
    <div className="max-w-screen-xl mx-auto px-4 py-6 lg:px-8">
      ...
      <div className="grid gap-6">
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Lirik Lagu Bahasa Sentani</h1>
            <p className="text-muted-foreground">
              Jelajahi kumpulan lirik lagu daerah dalam bahasa Sentani dengan terjemahan dalam bahasa Indonesia
            </p>
          </div>
